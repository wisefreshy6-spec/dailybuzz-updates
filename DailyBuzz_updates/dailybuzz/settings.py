...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "dupdateske@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "hejf tdvc xvfh zail")
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "dupdateske@gmail.com")